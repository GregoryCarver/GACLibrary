/**************************************************************************************************************************/
/* Simple camera class for moving around                                                                                  */
/* Camera was built in an old project using learnopengl.com and my own modifications                                      */
/**************************************************************************************************************************/
#pragma once
...
private:
	...
	void UpdateCameraVectors()
	{
		...
		std::cout << "Radians: " << glm::radians(pitch) << std::endl;
		std::cout << "Radians: " << sin(glm::radians(pitch)) << std::endl;
